                ...
                <table className=" table table-bordered table-hover ">
                    <thead >
                        <tr>
                            ...
                            <th scope="col"><h3>Link to the question</h3></th>
                        </tr>
                    </thead>
                    <tbody>
...
const Pcard = () => {
    return (<>
        {data.map((item) => {
            return (
                <div className=" col-sm-1 col-md-6 col-lg-4">
                    <div class="card mb-3 border-secondary" style={{ maxWidth: "28rem" }}>
                        <h3 class="card-header">{item.topicName}</h3>
                        <div class="card-body text-secondary">
                            <h5 class="card-title">Total No of Questions {item.questions.length}</h5>
                            <p class="card-text"><Link className="card-link" to='/Plistview' onClick={() => { console.log(item.topicName); dataSent = item }}>Let's face them</Link>
                            </p>
                        </div>
                    </div>
                </div>
...
export const PcardList = () => {
    return (<div class="container" style={{ width: "100vw", textAlign: "center" }}>
        <h2>450 DSA Cracker</h2>
        <h4>Your Gateway to crack DSA</h4>
