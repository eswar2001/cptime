    ...
    return (<><div className="container " style={{ width: "100vw", textAlign: "center" }}>
        ...
        <table className=" table table-dark table-bordered table-hover " style={{
            ...
            <tbody>
                ...
                <tr>
                    <td>★★☆</td>
                    <td><a href="http://web.ntnu.edu.tw/~algo/">演算法筆記 (Algorithm Notes) (Chinese)</a></td>
        ...
        <table className=" table table-dark table-bordered table-hover " style={{ overflowX: "auto" }}>
            ...
            <tbody>
                ...
                <tr>
                    <td>★★★</td>
                    <td><a href="http://goo.gl/M4yfbr">プログラミングコンテストチャレンジブック (Japanese)</a>, by 秋葉拓哉, 岩田陽一, 北川宜稔</td>
                ...
                <tr>
                    <td>★★☆</td>
                    <td><a href="http://www.tup.com.cn/booksCenter/book_05568701.html">算法竞赛入门经典 (Chinese)</a>, by 刘汝佳</td>
                    <td>The Art of Algorithms and Programming Contests (English), 打下好基礎：程式設計與演算法競賽入門經典 (Chinese Traditional)</td>
                </tr>
                <tr>
                    <td>★★☆</td>
                    <td><a href="https://www.amazon.cn/算法竞赛入门经典-训练指南-刘汝佳/dp/B009SJJGOU">算法竞赛入门经典——训练指南 (Chinese)</a>, by 刘汝佳, 陈锋</td>
                    <td>提升程式設計的解題思考力─國際演算法程式設計競賽訓練指南 (Chinese Traditional)</td>
                </tr>
                <tr>
                    <td>★★★</td>
                    <td><a href="http://goo.gl/O1tr8v">算法艺术与信息学竞赛 (Chinese)</a>, by 刘汝佳, 黄亮</td>
        ...
        <table className=" table table-dark table-bordered table-hover " style={{ overflowX: "auto" }}>
            ...
            <tbody>
                ...
                <tr>
                    <td>★★☆</td>
                    <td><a href="http://amzn.to/VjhioK">Algorithm Design</a>, by Jon Kleinberg and Éva Tardos</td>
        ...
        <table className=" table table-dark table-bordered table-hover " style={{ overflowX: "auto" }}>
            ...
            <tbody>
                <tr>
                    <td><a href="http://psyho.gg/overview-of-programming-contests/">Overview of Programming Contests</a>, by Przemysław Dębiak (Psyho)</td>
                </tr>
                <tr>
